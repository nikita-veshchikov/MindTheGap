...
The device features a 4.4~MHz clock, $<>$ bytes\todo{add values} of SRAM and $<>$ bytes of Flash memory. 
...
where $\mu_{x}$ and $\sigma_{x}^2$ are the estimated mean value and the estimated variance of the set $x$;
