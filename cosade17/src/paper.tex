...
\todo[inline]{Pro: I believe this kind of practical work is useful and the considered issue is worth investigating. Moreover, the provided experimental results give some insights on the distance-based leakage issue and possible ways to avoid it.
